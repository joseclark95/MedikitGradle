...
public class Main implements Controller {
    ...
    public void initialize() {
        ...
        navigationGroup.selectedToggleProperty().addListener(
                (ObservableValue<? extends Toggle> observable, Toggle oldValue, Toggle newValue) -> this.setCurrentPane(
                        ((newValue == null) ? WindowStyle.SHORTCUTS : (WindowStyle) newValue.getUserData())));
    ...
    private void showNotificationTooltip(int amount) {
        Bounds localBounds = notificationsToggle.getBoundsInLocal(),
                screenBounds = notificationsToggle.localToScene(localBounds);
